...
import { useContext as _useContext, createContext, createEffect, JSX, onCleanup } from 'solid-js';
...
export function createSolidQueryHooks<TProceduresLike extends ProceduresDef>() {
	...
	function createMutation<K extends TProcedures['mutations']['key'] & string, TContext = unknown>(
		key: K | [K],
